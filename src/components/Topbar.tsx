      ...
      <div className="flex items-center gap-6">
        ...
        <form onSubmit={handleLogin} className="flex items-center gap-3">
          ...
          <input
            ...
            className="h-7 px-3 text-xs font-mono bg-[var(--bg-input)] border border-[var(--border)] text-[var(--text-primary)] placeholder-[var(--text-tertiary)] focus:outline-none focus:ring-2 focus:ring-[var(--accent-blue)] transition-all w-36"
          ...
          <div className="relative group">
            <input
              ...
              className="h-7 pl-3 pr-8 text-xs font-mono bg-[var(--bg-input)] border border-[var(--border)] text-[var(--text-primary)] placeholder-[var(--text-tertiary)] focus:outline-none focus:ring-2 focus:ring-[var(--accent-blue)] transition-all w-40"
          ...
          <button
            ...
            className="h-7 px-4 text-xs font-mono font-bold uppercase tracking-wider rounded bg-[var(--accent-blue)] text-white hover:opacity-90 transition-all disabled:opacity-40"
          >
            {submitting ? "..." : "Login"}
          </button>
        </form>

      ...
      return (
        this.props.fallback ?? (
          <div className="flex-1 flex items-center justify-center bg-[var(--bg-void)]">
            <div className="glass rounded-2xl px-10 py-8 text-center card-3d max-w-md">
              ...
              <button
                ...
                className="px-4 py-1.5 text-[10px] font-bold uppercase tracking-widest text-[var(--bg-void)] bg-[var(--cyan)] hover:opacity-90 rounded transition-all"
              >
                Retry
              </button>
            </div>
